...
class CommentItemView(context: Context) : ViewGroup(context, null, 0) {
    ...
    private val tv_comment_body: TextView
    ...
    init {
        ...
        tv_comment_body = TextView(context).apply {
            id = R.id.tv_comment_body
            setTextColor(grayColor)
            textSize = 14f
        }
        addView(tv_comment_body)
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        tv_comment_body.width = width - paddingLeft - paddingRight
        measureChild(tv_comment_body, widthMeasureSpec, heightMeasureSpec)

        usedHeight += tv_comment_body.measuredHeight + defaultVSpace
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        tv_comment_body.layout(
            left,
            usedHeight,
            left + tv_comment_body.measuredWidth,
            usedHeight + tv_comment_body.measuredHeight
        )
    }
    ...
    fun bind(item: CommentItemData?) {
        if (item == null) {
            ...
            tv_comment_body.text = item.body
